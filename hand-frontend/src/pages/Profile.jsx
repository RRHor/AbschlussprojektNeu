...
//             email: userData.email || '',
//             password: '••••••••••',
//             firstName: userData.addresses?.[0]?.firstName || '',
//             lastName: userData.addresses?.[0]?.lastName || '',
...
//           email: editData.email,
//           addresses: [{
//             firstName: editData.addresses.firstName,
//             lastName: editData.addresses.lastName,
//             street: editData.addresses.street,
//             city: editData.addresses.city,
//             district: editData.addresses.district,
//             zipCode: parseInt(editData.addresses.zipCode, 10)
//           }]
//         })
//       });
//       if (response.ok) {
...
//                 </div>
//                 <h2 className="profile-name">
//                   {/* {isEditing ? editData.addresses.firstName : profileData.addresses.firstName} {isEditing ? editData.addresses.lastName : profileData.addresses.lastName} */}
//                   {isEditing ? editData.addresses?.[0]?.firstName : profileData.firstName} {isEditing ? editData.addresses?.[0]?.lastName : profileData.lastName}
//                 </h2>
//                 <p className="profile-username">
//                   @{isEditing ? editData.nickname : profileData.nickname}
//                 </p>
