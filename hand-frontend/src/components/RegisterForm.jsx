...
const RegisterForm = ({ onSuccess = () => {} }) => {
  ...
  // --- Hier ist die einzige handleSubmit-Funktion ---
      ...
      const response = await fetch('http://localhost:4000/api/auth/register', {
        ...
        body: JSON.stringify({
          ...
          adress: {
            ...
            zipCode: formData.zipCode, // <-- Wichtig: "zip" statt "zipCode"
...
//   // Zeile 62-66: Start der Submit-Funktion, setzt Ladezustand und leert Fehlermeldungen
// const handleSubmit = async (e) => {
//   e.preventDefault();         // Verhindert das Standard-Formularverhalten (Seitenreload)
//   setIsSubmitting(true);      // Setzt den Button auf "Laden"
//   setMessage('');             // Leert vorherige Nachrichten
//   setFormErrors({});          // Leert vorherige Validierungsfehler
...
//           city: formData.city,
//           district: formData.district,
//           zip: formData.zipCode, // <-- Wichtig: "zip" statt "zipCode"
//           firstName: formData.firstName,
//           lastName: formData.lastName
//         }
//       }),
...
//     const data = await response.json();
//     if (response.ok) {
//       localStorage.setItem('token', data.token); // Token speichern (optional)
//       onSuccess(data);                           // Callback bei Erfolg
...
//             city: formData.city,
//             district: formData.district,
//             zipCode: parseInt(formData.zip, 10),
//           },
//         }),
//       });
